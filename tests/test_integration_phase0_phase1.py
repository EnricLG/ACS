"""
Integration test: Phase 0 (preprocessing) + Phase 1 (rotations)
with the complete 1984 text. Shows the grid before and after rotations.
"""
...
# Texto completo de 1984 (el mismo que en test_phase0)
