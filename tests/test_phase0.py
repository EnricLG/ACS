"""
Test de la Fase 0 (preprocesamiento) con el texto completo de 1984.
...
# Texto completo de 1984 (primeros párrafos hasta donde nos pasó el usuario)
...
print("=" * 70)
print("🔐 FASE 0 – TEST CON TEXTO COMPLETO DE 1984 (GEORGE ORWELL)")
print("=" * 70)
...
grid, seed = phase0.process(texto_1984_completo)
